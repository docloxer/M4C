...
{N}[{H}+{N}] {H}LIVE{N}
 ...
 {N}├╴>{N} following : {H}{ful}{N}
    ...
    def UgentsLite(self):
        ...
        useragent = f'''Mozilla/5.0 (Linux; Android 8.1.0; {self.a} SAMSUNG SM-J610F) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/20.0 Chrome/{self.b}.0.{self.c}.{self.d} Mobile Safari/537.36'''
        return useragent
